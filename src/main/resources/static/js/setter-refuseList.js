...
//     // 각 심사관련 문의하기 버튼에 대한 클릭 이벤트 리스너 추가
//     $('.inquiry-btn').click(function() {
//
//         // 모달 열기
//         $('.inquiry-modal').show();

        // // 클릭한 버튼의 데이터 속성에서 펀딩 코드와 사용자 ID 가져오기
        // var fndCode = $(this).data('fnd-code');
        // var userId = $(this).data('user-id');
        //
        // // 모달에 펀딩 코드와 사용자 ID 입력
        // $('#insert-fndCode').val(fndCode);
        // $('#insert-userId').val(userId);

        // 현재 시간 입력
    //     $('#insert-dateTime').val(getCurrentDateTime());
    //
    // });
    //
    // // 모달 닫기 버튼 클릭 시 모달 닫기
...
// $(document).ready(function() {
//     // 첨부파일 업로드 버튼 클릭 시
//     $('#insert-file-upload-btn').click(function(event) {
//         event.preventDefault(); // 기본 이벤트 동작 방지
//
//         // 선택된 파일 가져오기
//         var files = $('#insert-file')[0].files;
//
//         // FormData 객체 생성
